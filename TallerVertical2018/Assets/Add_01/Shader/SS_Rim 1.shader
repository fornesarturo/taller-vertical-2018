Shader "Custom/NewSurfaceShader" {
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			o.Albedo = tex2D(_AlbedoTex, IN.uv_AlbedoTex).rgb*tex2D(_AOTex, IN.uv_AlbedoTex).rgb;
			...
			o.Smoothness = tex2D(_SmoothTex, IN.uv_AlbedoTex).a;

			o.Metallic = tex2D(_MetallicTex, IN.uv_AlbedoTex).r;
